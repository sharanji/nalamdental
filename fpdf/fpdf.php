...
class FPDF
{
	...
	*******************************************************************************/
	...
	function __construct($orientation='P', $unit='mm', $size='A4')
	{
		...
		$this->StdPageSizes = array(
			...
			'barcode'    => array(283.4,393), 
			'asn_barcode'    => array(189.4,393), 
			'supplier_shipment'    => array(120,150), 
			'barcodenew' => array(189,393)
		);
	...
	function setFooter($sftr='Y')
	{
		if ($sftr =='Y') $this->dftr = 'Y';
		else $this->dftr = 'N';
	}
	...
	*******************************************************************************/
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function CellHead($w, $h=0, $txt='', $border=0, $ln=1, $align='', $fill=false, $link='')
	{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function CellFilter($w, $h=0, $txt='', $border=0, $ln=1, $align='', $fill=false, $link='')
	{
		$border = 1;
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	function Cellwhite($w, $h=0, $txt='', $border=0, $ln=1, $align='', $fill=false, $link='')
	{
		$border = 1;
	...
	function Row2($data)
	{
		...
		$nb=max($nb,$this->NbLines($this->widths[$i],$data[$i]));
		$h=18*$nb;
		//$this->SetDrawColor('160','82','45'); ///LINE COLOUR
		//$this->SetFillColor('255','255','255');
		//$this->SetTextColor('160','82','45'); ///TEXT COLOUR
		//Issue a page break first if needed
	...
	function CheckPageBreak1($h)
	{
		//If the height h would cause an overflow, add a new page immediately
		if($this->GetY()+$h>$this->PageBreakTrigger)
			$this->AddPage1($this->CurOrientation);
	}
	///////////////////////////////////////////////

	function letterhead_a4l()
	{
		$this->image('../images/logo1.jpg','70','10','190','30','jpg');
		$this->ln(30);
	}

	function letterhead_a4p()
	{
		$this->image('../images/logo.jpg','10','5','190','30','jpg');
		$this->ln(25);

	}

	function letterhead_short()
	{
		$this->image('../images/logo1.jpg','10','10','130','20','jpg');
		$this->ln(20);

	}


	function letterhead_a4bill1()
	{
		$this->image('../images/logo1.jpg','15','10','90','15','jpg');
		$this->ln(20);

	}


	function letterhead_a4bill2()
	{
		$this->image('../images/logo1.jpg','15','10','90','15','jpg');
		$this->image('../images/logo1.jpg','115','10','90','15','jpg');
		$this->ln(20);
