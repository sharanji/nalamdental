...
(function(factory) {
    ...
    Magnify.prototype = {
        ...
        <div class="magnify-stage">\
          <img class="magnify-image" src="" alt="best dental hospial hosur" />\
        </div>\
        ...
        loadImg: function(imgSrc, fn, err) {
            ...
            if (isIE8()) {
                this.$stage.html(
                    '<img class="magnify-image" id="magnify-image" src="' + imgSrc + '" alt="best dental hospial hosur" />'
                );
            } else {
        ...
        keydown: function(e) {
            ...
            switch (keyCode) {
                ...
                case 187:
                    self.zoom(
                        self.options.ratioThreshold * 3, { x: self.$stage.width() / 2, y: self.$stage.height() / 2 },
                        e
                    );
                    break;
                    // -
                case 189:
                    self.zoom(-self.options.ratioThreshold * 3, { x: self.$stage.width() / 2, y: self.$stage.height() / 2 },
                        e
                    );
                    break;
                    // + Firefox
                ...
                case 48:
                    if (ctrlKey && altKey) {
                        self.zoomTo(
                            1, { x: self.$stage.width() / 2, y: self.$stage.height() / 2 },
                            e
                        );
                    }
                    break;
