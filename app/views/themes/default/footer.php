                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-3 col-sm-6 order-1 text-center text-sm-start xs-mb-20px">
                                <a href="home.html" class="footer-logo d-inline-block"><img src="<?php echo base_url();?>assets/frontend/img/logo.png" data-at2x="<?php echo base_url();?>assets/frontend/img/logo.png" alt=""></a>
                            </div>
                            <!-- end footer column -->
                            <!-- start footer column -->
                            <div class="col-xl-9 order-3 order-xl-2 lg-mt-10px">
