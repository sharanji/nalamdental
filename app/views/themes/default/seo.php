            ...
            <div class="container">
                <div class="row align-items-center justify-content-center extra-very-small-screen">
                    <div class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="fw-700 text-dark-gray mb-20px ls-minus-2px">SEO</h1>
                        <h2 class="fw-400 ls-0px mb-0">Search Engine Optimization Services</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container"> 
                <div class="row">
                    <div class="col-xl-5 col-lg-6" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <span class="fs-14 fw-600 text-dark-gray text-uppercase d-block mb-15px"><i class="bi bi-patch-check-fill fs-15 text-dark-gray me-5px"></i>SEO solutions to enhance your online visibility</span>
                        <h3 class="text-dark-gray fw-600 ls-minus-2px">Rank higher, reach farther.</h3>
                    </div>
                    <div class="col-xl-6 col-lg-6 offset-xl-1" data-anime='{ "el": "childs", "translateX": [-50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <p class="w-90 lg-w-100">Securing a prominent position on search engine results is critical for success in today's ever-changing digital market. We recognize the importance of Search Engine Optimization (SEO) in driving organic traffic, increasing exposure, and ultimately growing your online business at <?php echo SITE_NAME; ?>.</p>
        ...
        */ ?>
        ...
        <section class="p-0 top-space-margin page-title-center-alignment">
            <div class="container">
                <div class="row align-items-center justify-content-center extra-very-small-screen">
                    <div class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="fw-700 text-dark-gray mb-20px ls-minus-2px">SEO process </h1>
        ...
        <section class="position-relative overflow-hidden section-dark">
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="row">
                            <div class="col-md-3">
                                <div class="fs-16 fw-600 text-dark-gray">Analysis and Audit</div>
                            </div>
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>We begin by thoroughly analyzing your current web presence. Our thorough audit highlights strengths, shortcomings, and chances for improvement.</p>
                            </div>
                        </div>
                        <div class="separator-line-1px bg-dark-gray mt-35px mb-35px"></div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fs-16 fw-600 text-dark-gray">Strategy Development</div>
                            </div>
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>Based on our findings, we create a customized SEO plan that corresponds with your company's goals. This involves keyword research, content optimization, and a strategy for long-term growth.</p>
                            </div>
                        </div>
                        <div class="separator-line-1px bg-dark-gray mt-35px mb-35px"></div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fs-16 fw-600 text-dark-gray">Implementation</div>
                            </div>
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>Our team tirelessly implements the agreed-upon approach, optimizing your website for search engines and developing high-quality, engaging content that resonates with your target audience.</p>
                            </div>
                        </div>
                        <div class="separator-line-1px bg-dark-gray mt-35px mb-35px"></div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fs-16 fw-600 text-dark-gray">Monitoring and Adjustment </div>
                            </div>
                            <div class="col-md-9 last-paragraph-no-margin">
                                <p>SEO is a continuous process. We regularly monitor performance indicators, evaluate user behavior, and make necessary adjustments to ensure long-term growth and success.</p>
                            </div>
                        </div>
                    </div>
                </div>
