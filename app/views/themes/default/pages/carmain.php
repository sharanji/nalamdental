                                                        ...
                                                        <td>
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <!-- <h2 style="font-weight:400;" title="<?php echo ucfirst($item["product_description"]); ?>"><?php echo ucfirst($item["product_description"]); ?></h2> -->
                                                                    <h2 style="font-weight: 400;" title="<?php echo ucfirst($item["product_description"]); ?>">
                                                                        <?php
                                                                            $description = ucfirst($item["product_description"]);
                                                                            echo "<h2 style=\"font-weight: 400;\" title=\"$description\">" . substr($description, 0, ) . "...</h2>";
                                                                        ?>
                                                                    </h2>
