                    ...
                    <div class="container-fluid">
                        <div class="col-auto col-lg-2 me-lg-0 me-auto">
                            <a class="navbar-brand" href="home.html">
                                ...
                                <img src="<?php echo base_url();?>uploads/favicon.png" data-at2x="<?php echo base_url();?>uploads/favicon.png" alt="nalam dental care" class="default-logo"> 
                            </a>
                        </div>
                        ...
                        <div class="col-auto col-lg-2 text-end d-none d-sm-flex">
                            <div class="header-icon"> 
                                <div class="header-button">
                                    <a href="appointment.html" class="btn btn-small btn-switch-text btn-base-color left-icon btn-round-edge btn-box-shadow">
                                        <span>
