					...
					<div class="row">
						<div class="col-md-4">
							<div class="row">
								...
								<input type="text" name="keywords" autocomplete="off" id="keywords" value="<?php echo isset($_GET['keywords']) ? $_GET['keywords'] : NULL; ?>" placeholder="Candidate Name / Mobile Number/ Email" class="form-control">
								</div>
							</div>
