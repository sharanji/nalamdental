<div class="content"><!-- Content start-->
	<div class="card"><!-- Card start-->
		<div class="card-body">
			<!-- buttons start here -->
			<div class="row mb-2">
				<div class="col-md-6"><h3><b>Home Delivery Orders</b></h3></div>
			</div>
			<!-- buttons end here -->
				...
				<form action="" class="form-validate-jquery" method="get" >
					...
					<div class="row mt-2">
						...
						<div class="col-md-4 float-right text-right">
							<a href="<?php echo base_url(); ?>home_delivery/manageHomeDeliveryOrders" title="Clear" class="btn btn-default btn-sm">Clear</a>
												...
												<td class="tab-md-100 text-center">
													...
													<?php
														/* if($row['payment_due'] == 'Unpaid')
														{
															?>
																&nbsp;|&nbsp;
																<a class="payment_update" href="<?php echo base_url();?>home_delivery/manageHomeDeliveryOrders/payment_update/<?php echo $row['header_id'];?>/Paid" title="Payment Update">
