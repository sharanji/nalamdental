											...
											foreach ($items as $key) 
											{
												...
												<tr>
													...
													<td class='tab-medium-width'>
														...
														<a style="color:<?php echo  $fontColor;?>" href="javascript:void(0);" data-toggle="modal" data-target="#exampleModal<?php echo $key->branch_item_line_id;?>">
															Ingredients (<?php echo count($getBranchIngredien);?>)
														</a>

														<!-- Modal -->
														<div class="modal fade" id="exampleModal<?php echo $key->branch_item_line_id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
													...
													<td class='tab-medium-width text-center'>
														...
														<?php 
															if($key->item_status == 1)
															{
																?>
																<label class="switch">
																	<input class="item_status" name="item_status" type="checkbox" checked id="<?php echo $key->branch_item_line_id;?>">
															...
															{ 
																?>
																<label class="switch">
																	<input class="item_status" name="item_status" type="checkbox" id="<?php echo $key->branch_item_line_id;?>">
																	<div class="slider round"></div>
																</label>
																<?php 
															} 
