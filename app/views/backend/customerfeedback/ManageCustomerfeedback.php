			...
			<form action="" class="form-validate-jquery" method="get">
				...
				<div class="row">
					...
					<div class="col-md-4 -float-right -text-right">
						...
						<a href="<?php echo base_url(); ?>customerfeedback/ManageCustomerfeedback" title="Clear" class="btn btn-default">Clear</a>
					</div>
				</div>
			</form>
			<!-- filters-->
							...
							<table id="myTable" class="table table table-bordered">
								<thead>
									<tr>
										...
										<th style="width:12%;" class="text-center">Mobile Number</th>
