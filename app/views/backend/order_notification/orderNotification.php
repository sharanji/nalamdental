<?php 
	...
	left join cus_consumers as customer on customer.customer_id = header_tbl.customer_id
	...
	and (line_tbl.cancel_status = 'N' or header_tbl.cancel_status = 'N')
			...
			<li class="media">
				<div class="media-body">
						<div class="media-title">
							<span class="font-weight-semibold" style="color:Blue;"><a href="<?php echo base_url();?>orders/openOrders/readOrders/<?php echo $row['header_id'];?>"><?php echo $row["order_number"];?></a></span>
	...
	else 
	{
		?>
		<div class="no-orders">
			<img src="<?php echo base_url()?>uploads/nodata.png" class="w-70" style="margin-left:45px;" alt="No Orders">
			<!--<div class="text-center text-muted">No New notification</div>-->
		</div>
		<?php
	}
