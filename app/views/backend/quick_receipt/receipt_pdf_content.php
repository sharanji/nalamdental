...
<table width="100%" style="font-size:12px;">
	...
	<tbody>
				...
				foreach($line_data as $lineItems)
				{
					...
					<tr>
						...
						<td class="tab-md-150" style="text-align:center">
							<?php echo $lineItems["received_qty"];?>
						</td>
						...
						<td class="tab-md-100" style="text-align:right">
							...
							<?php 
								$total=$lineItems["base_price"]*$lineItems["received_qty"];
		...
		<tr style="border-top:none !important;width:100%">
			<td colspan="6" style="border-bottom:none ! important;border-top:none ! important"></td>
