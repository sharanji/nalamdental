        ...
        <div class="row mb-1">
            <div class="col-md-6">
                <a href="<?php echo base_url();?>admin/home" >
                    <img src="<?php echo base_url();?>uploads/logo.png" style="width:200px;height:35px;">
                </a>
                &nbsp;&nbsp;&nbsp;
            ...
            <div class="col-md-6">  
                <div class="row">
                    ...
                    <div class="col-md-4 pos_dining_type">
                ...
                <div class="col-md-4">
                    ...
                    <?php 
                        ...
                        { 
                            ...
                            else if( (isset($order_type) && $order_type == 'takeaway') 
                                ...
                                if(count($posOrders)> 0)
                                {
                                    ...
                                    foreach($posOrders as $openOrdersRow)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href='<?php echo base_url();?>pos/posOrder/takeaway/<?php echo $openOrdersRow["interface_status"]; ?>/<?php echo $openOrdersRow["interface_header_id"]; ?>'>
