...
<?php 
		...
		rcv_header.receipt_number as reference_no,
			...
			<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
				...
				<div class="d-flex">
					<div class="breadcrumb">
						...
						<a href="<?php echo base_url();?>payment/manageSupplierPayment" class="breadcrumb-item">
							<?php echo $page_title;?>
						</a>
					</div>
				</div>
				...
				<div class="top-right" style="float:right;">
					...
					<a href="<?php echo base_url();?>payment/manageSupplierPayment" class="btn btn-outline-primary btn-sm mr-1" title="Back">
					...
					<a title="Generate PDF" target="_blank" href="<?php echo base_url(); ?>payment/supplierPaymentPDF/<?php echo $id;?>" class="btn btn-outline-primary mr-1 btn-sm" href="javascript:void(0);">
					...
					<table class="table-products table-bordered table-hover" width="100%" style="font-size:12px;">
						<thead style="border-bottom:1px solid #ddd;">
							<tr style="border-top:none !important;border-bottom:1px solid #ddd;">
								<th style="border-right:none !important;border-top:none !important;border-bottom:1px solid #ddd;font-size:12px;">S.No</th>
								<th style="border-right:none !important;border-top:none !important;border-bottom:1px solid #ddd;font-size:12px;">PO Number</th>
								<th style="border-right:none !important;border-top:none !important;border-bottom:1px solid #ddd;font-size:12px;">Receipt Number</th>
								<!-- <th>Category</th> -->
								...
								<th style="border-right:none !important;border-top:none !important;text-align:right;border-bottom:1px solid #000;font-size:12px;">Paid Amount</th>  
							</tr>
							...
							<?php
								...
								foreach ($getInvoiceItems as  $key) 
								{
									...
									<tr>
										...
										<td style="text-aign:center;border-bottom:none!important;border-right:none !important;"><?php echo ($i); ?></td>
										<td style="border-bottom:none!important;border-right:none !important;"><?php echo ucfirst($key->po_number); ?></td>
										<td style="border-bottom:none!important;border-right:none !important;"><?php echo ucfirst($key->reference_no); ?></td>
										<td class="tab-medium-width text-left"><?php echo isset($getInvoiceDetails[0]['payment_date']) ? date(DATE_FORMAT,strtotime(($getInvoiceDetails[0]['payment_date']))):"";?></td>
