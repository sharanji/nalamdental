												...
												<div class="col-lg-3">
													...
													<?php 
														if($type == "edit")
														{
															...
															{
																?><br>
																<img src="<?php echo base_url()."uploads/banner/".$edit_data[0]['banner_id'].'.png';?>" width="100" height="60" alt="best dental hospial hosur"> 
																<?php
															}
														}
													?>
														...
														<tr>
															...
															<td class="text-center">
																<?php
																	...
																	{
																		?>
																		<img src="<?php echo base_url()."uploads/banner/".$row['banner_id'].'.png';?>" width="70" height="50" alt="best dental hospial hosur"> 
																		<?php
																	}
																	else
																	{
