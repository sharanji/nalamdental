...
<div class="modal fade" id="importcountryCSV" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url(); ?>suppliers/ManageSupplierSites/import" enctype="multipart/form-data" method="post">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<a href="<?php echo base_url(); ?>assets/sample_supplier_sites.csv" class="btn btn-info btn-flat btn-sm pull-right" title="Download Sample File">
		...
		<div class="card-body">
			<?php
				if( isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
					...
					$getSupplier = $this->db->query("select supplier_id, supplier_name from sup_suppliers where active_flag = 'Y' order by supplier_name asc")->result_array();
					?>
					<form action="" class="form-validate-jquery" enctype="multipart/form-data" method="post">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								...
								<a href="<?php echo base_url(); ?>suppliers/ManageSupplierSites" class="btn btn-default btn-sm">Close</a>
							</div>
							...
							<?php /*
								if($type == "view")
								{
									?>
									<div class="col-md-6 text-right">
										<a class="btn btn-sm btn-primary edit-icon" href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/edit/<?php echo $id;?>" title="Edit">
						...
						<fieldset class="mb-3"<?php echo $fieldSetDisabled;?>>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="row">
										<label class="col-form-label col-md-4 text-right supplier_id"><span class="text-danger">*</span> Supplier Name</label>
										<div class="form-group col-md-5">
											<select name="supplier_id" id="supplier_id" required class="form-control <?php echo $searchDropdown;?>">
												<?php
									...
									<div class="row">
										...
										<div class="form-group col-md-5">
											<input type="text" name="contact_person" autocomplete="off" id="contact_person" class="form-control single_quotes" value="<?php echo isset($edit_data[0]['contact_person']) ? $edit_data[0]['contact_person'] :"";?>" placeholder="Contact Person">														
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group col-md-5">
											<input type="text" name="gst_number" <?php echo $this->validation;?> autocomplete="off" id="gst_number" maxlength="15" minlength="15" class="form-control" value="<?php echo isset($edit_data[0]['gst_number']) ? $edit_data[0]['gst_number'] :"";?>" placeholder="GST Number">
								...
								<div class="col-md-6">
									<div class="row">
										<label class="col-form-label col-md-4 text-right site_name"><span class="text-danger">*</span> Site Name</label>
										<div class="form-group col-md-5">
											<input type="text" name="site_name" autocomplete="off"  id="site_name" required class="form-control single_quotes" value="<?php echo isset($edit_data[0]['site_name']) ? $edit_data[0]['site_name'] :"";?>" placeholder="Site Name">
										</div>
									</div>
									<div class="row">
										<label class="col-form-label col-md-4 text-right mobile_number"><span class="text-danger">*</span> Mobile Number</label>
										<div class="form-group col-md-5">
											<input type="text" name="mobile_number" autocomplete="off" required <?php echo $this->validation;?> id="mobile_number" class="form-control mobile_vali" minlength='10' maxlength='10' value="<?php echo isset($edit_data[0]['mobile_number']) ? $edit_data[0]['mobile_number'] :"";?>" placeholder="Mobile Number">										
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group col-md-5">
											<input type="email" name="email_address" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$." autocomplete="off" id="email_address" class="form-control single_quotes" value="<?php echo isset($edit_data[0]['email_address']) ? $edit_data[0]['email_address'] :"";?>" placeholder="Email">
					...
					<script type="text/javascript">  
						...
						function saveBtn(val) 
						{
							...
							if (supplier_id && mobile_number && country_id && state_id && site_name && city_id && address1 && postal_code && pan_number && account_number && account_holder_name && ifsc_code && branch_name && bank_name)
							{
								...
								$(".site_name").removeClass('errorClass');
				...
				{ 
					...
					<!-- buttons start here -->
					<div class="row mb-2">
						<div class="col-md-6"><h3><b>Supplier Sites</b></h3></div>
						<div class="col-md-6 float-right text-right">
							<?php
								if((isset($supplierSitesMenu['create_edit_only']) && $supplierSitesMenu['create_edit_only'] == 1) || $this->user_id == 1)
								{
									?>
									...
									<a href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/add" class="btn btn-info btn-sm">
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row">
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-4 text-right">Supplier Name <!-- <span class="text-danger">*</span> --></label>
							...
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-4 text-right">Site Name <!-- <span class="text-danger">*</span> --></label>
									<div class="form-group col-md-8">
						...
						<div class="row mt-2">
							...
							<div class="col-md-4" style="padding:0px 4px 2px 75px;">
								<button type="submit" class="btn btn-info">Search <i class="fa fa-search" aria-hidden="true"></i></button>
								&nbsp;<a href="<?php echo base_url(); ?>suppliers/manageSupplierSites" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
								...
								<table id="myTable" class="table table-bordered table-hover --table-striped dataTable">
									<thead>
										<tr>
											...
											<th onclick="sortTable(4)">Contact Person</th>
													...
													<td class="text-center">
														<div class="dropdown" --style="width: 80px;">
															...
															<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																<?php
																	if($supplierSitesMenu['create_edit_only'] == 1 || $supplierSitesMenu['read_only'] == 1 || $this->user_id == 1)
																	{ 
																		?>
																		<?php
																			if($supplierSitesMenu['create_edit_only'] == 1 || $this->user_id == 1)
																			{ 
																				?>
																				<li>
																					<a title="Edit" href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/edit/<?php echo $row['supplier_site_id'];?>">
																		...
																		<?php
																			if($supplierSitesMenu['read_only'] == 1 || $this->user_id == 1)
																			{ 
																				?>
																				<li>
																					<a title="View" href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/view/<?php echo $row['supplier_site_id'];?>">
																			...
																			{ 
																				...
																				<li>
																					<?php 
																						...
																						{
																							?>
																							<a href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/status/<?php echo $row['supplier_site_id'];?>/N" title="Block">
																						...
																						{  ?>
																							<a href="<?php echo base_url(); ?>suppliers/ManageSupplierSites/status/<?php echo $row['supplier_site_id'];?>/Y" title="Unblock">
