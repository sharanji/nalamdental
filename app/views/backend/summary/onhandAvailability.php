		...
		<div class="card-body">
			...
			<form action="" class="form-validate-jquery summary_form" method="get">
				<div class="row my-3">
					...
					<div class="col-md-4">
						<div class="row">
							...
							<div class="form-group col-md-8">
								...
								<select id="organization_id" onchange="getBranches(this.value);" name="organization_id" class="form-control searchDropdown">
					...
					<div class="col-md-4 offset-8 text-right">
						...
						<a href="<?php echo base_url(); ?>summary/onhandAvailability" title="Clear" class="btn btn-default btn-sm">Clear</a>
					</div>
			...
			<script type="text/javascript">
				...
				$("form.summary_form").submit(function (e) 
				{
					...
					if((organization_id && branch_id) || item_id) //Expiry
					{		
					...
					{
						$(".search_required").html("Please select Organization and Branch!");
						return false;
					}
				});
			</script>
