				...
				<form action="" class="form-validate-jquery" method="get" >
					...
					<div class="row mt-2">
						...
						<div class="col-md-2">
							...
							<a href="<?php echo base_url(); ?>summary/printJobStatusSummary" title="Clear" class="btn btn-default">Clear</a>
						</div>
					</div>
								...
								?>
									...
									<div class="row">
										<div class="col-md-8 mt-3">
											<?php /* <a href="<?php echo base_url().$this->redirectURL.'&download_excel=download_excel'; ?>" title="Download to Excel" class="btn btn-primary btn-sm">
												Download to Excel
											</a>*/ ?>
										</div>
							...
							<table class="table table-bordered table-hover">
								<thead>
									<tr>
										...
										<th class="tab-md-120">Order #</th>
										<th class="tab-md-120">Job ID</th>
										<th class="tab-md-150">Description</th>
										<th class="tab-md-120">File</th>
										<th class="tab-md-120">Print Type</th>
										<th class="tab-md-150">Sent to Printer</th>
										<th class="tab-md-120">Print Status</th>
										<th class="tab-md-150">Auto Print Count</th>
										<th class="tab-md-150">Maual Print Count</th>
										<th class="tab-md-150">JSPM Socket Status</th>
										<th class="tab-md-120">Created By</th>
									...
									<?php 
										foreach($resultData as $row)
										{
											...
											<tr>
												...
												<td>
													<?php echo $row['print_type'];?>
												</td>

												<td>
													<?php echo $row['sent_to_printer'];?>
												</td>
												...
												<td>
													<?php echo $row['auto_print_count'];?>
												</td>

												<td>
													<?php echo $row['manual_print_count'];?>
												</td>

												<td>
													<?php echo $row['jspm_status'];?>
												</td>
												...
												<td>
													<?php echo date('d-M-Y h:m:i A',strtotime($row['created_date']));?>
												</td>				
											</tr>
											<?php
										}
