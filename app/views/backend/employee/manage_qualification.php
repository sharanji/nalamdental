	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="<?php echo base_url();?>employee/Manage_qualification" class="breadcrumb-item"><?php echo $page_title;?></a>
			</div>
		</div>
		<?php
			...
			{ 
				...
				<div class="d-flexad" style="text-align:right;">
					...
					<a href="<?php echo base_url(); ?>employee/Manage_qualification/add" class="btn btn-info">
						Add Qualification
					</a>
				</div>
				<?php 
					...
					if(isset($type) && $type == "add" || $type == "edit")
					{
						...
						<legend class="text-uppercase font-size-sm font-weight-bold">
							...
							<form action="" class="form-validate-jquery" --id="formValidation" enctype="multipart/form-data" method="post">
										...
										<fieldset class="mb-3">
											<div class="row">
												<div class="form-group col-md-3">
													<label class="col-form-label">Qualification Name <span class="text-danger">*</span></label>
													<input type="text" name="qualification_name" required <?php //echo $this->validation; ?> class="form-control" value="<?php echo isset($edit_data[0]['qualification_name']) ? $edit_data[0]['qualification_name'] :"";?>" placeholder="">
												</div>
											</div>
								...
								<div class="d-flexad" style="text-align:right;">
									<a href="<?php echo base_url(); ?>employee/Manage_qualification" class="btn btn-danger">Cancel  </a>
									<?php 
										if($type == "edit")
										{
											?>
					...
					{ 
								...
								<div class="col-md-8">
									<div class="row">
										<div class="col-md-4">	
											...
											<p class="search-note">Note : Qualification Name.</p>
										</div>	
						...
						<div class="new-scroller">
							<table id="myTable" class="table table-bordered table-hover table-striped dataTable">
								<thead>
									<tr>
										<th style="width:5%;">Controls</th>
										<th onclick="sortTable(1);">Qualification Name</th>
														...
														<ul class="dropdown-menu dropdown-menu-right">
															...
															<li>
																<?php 
																	...
																	{
																		?>
																		<a href="<?php echo base_url(); ?>employee/manage_qualification/status/<?php echo $row['qualification_id'];?>/0" title="Block">
																	...
																	{  ?>
																		<a href="<?php echo base_url(); ?>employee/manage_qualification/status/<?php echo $row['qualification_id'];?>/1" title="Unblock">
