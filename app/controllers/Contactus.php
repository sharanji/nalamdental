...
class Contactus extends CI_Controller 
{
	...
	function manageContactUs($type = '', $id = '', $status = '')
    {
		...
		if($_GET)
		{
			...
			$this->redirectURL = 'contactus/manageContactUs?customer_name='.$customer_name.'';
			...
			if($download_excel != NULL) 
			{
				...
				fputcsv($handle, array("S.No","Customer Name","Email","Mobile Number","Message","Subject","Created Date")); //, "Price" , "Total"
				$cnt=1;
